...
if (!localStorage.getItem("username") || !localStorage.getItem("password") || users.find(t => t.user == localStorage.getItem("username") && t.key == localStorage.getItem("password"))) location.href = "/default.html";
